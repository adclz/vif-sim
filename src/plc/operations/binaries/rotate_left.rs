...
use crate::plc::primitives::boxed::operations::{box_rotate_left_plc_primitive};
...
impl BuildJsonOperation for RotateLeft {
    fn build(
        &self,
        ...
        box_rotate_left_plc_primitive(&rotate, &rotate_with, &None, registry)
    }
}
